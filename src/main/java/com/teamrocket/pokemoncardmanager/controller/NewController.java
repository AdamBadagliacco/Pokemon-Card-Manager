...
public class NewController {
	...
	public String login(@RequestParam("user") String username, @RequestParam("password") String pwd) {
		...
		// Check if User exists (if they do, check if the password is right. If not,
		// return exception the User doesn't have an account)
	...
	public String signUp(@RequestParam("user") String username, @RequestParam("password") String pwd) {
		...
		//user.setToken(token);//Token is too long to save
		users.save(user);
	...
	public User getCollection(@RequestParam("user") String username, @RequestParam("password") String pwd) {
		...
		// Check that the username , password, and token against the database, if any
		// are incorrect return an error
